...
public class HMAvroReadSupport extends ReadSupport<ComparableHashMap> {
  ...
  @Override
  public RecordMaterializer<ComparableHashMap> prepareForRead(Configuration configuration, Map<String, String> keyValueMetaData, MessageType fileSchema, ReadContext readContext) {
    ...
    return new HMAvroMaterializer(parquetSchema, avroSchema);
  }
}
