 ...
 */
public class HMAvroParquetSupportInputFormat extends DeprecatedParquetInputFormat<Map> {
  ...
  public static void setRequestedProjection(Configuration configuration, Schema requestedProjection) {
    HMAvroReadSupport.setRequestedProjection(configuration, requestedProjection);
  }

  public static void setReadSupportClass(Configuration configuration,  Class<?> readSupportClass) {
    configuration.set(ParquetInputFormat.READ_SUPPORT_CLASS, readSupportClass.getName());
  }
  ...
  public static void setAvroReadSchema(Configuration configuration, Schema avroReadSchema) {
    HMAvroReadSupport.setAvroReadSchema(configuration, avroReadSchema);
  }
